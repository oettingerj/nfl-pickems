...
<Card noPadding class={$$restProps.class}>
    <div class="flex justify-between text-gray-800">
        ...
        <div class="flex flex-col items-center justify-center px-3 md:px-10 bg-gray-100" style={dragDisabled ? 'cursor: grab' : 'cursor: grabbing'} on:mousedown={startDrag} on:touchstart={startDrag}>
